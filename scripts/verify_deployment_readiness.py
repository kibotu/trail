#!/usr/bin/env python3
"""Verify deployment readiness - checks vendor and configuration."""
...
def check_php_extensions():
    """Check if required PHP extensions are available locally."""
...
def main():
    ...
    if all_passed:
        ...
        print("\nNext steps:")
        print("  Deploy: cd scripts && uv run python full_deploy.py")
        return 0
    else:
